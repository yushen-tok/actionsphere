...
// Assign x values based on array keys
foreach ($dataPoints as $key => &$dataPoint) {
    $dataPoint["x"] = $key + 1;  // Incrementing by 1 to start from 1
}

// Print the modified dataPoints array
print_r($dataPoints);
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "Column Chart of Movies (Action Sphere)"
	},
	axisY:{
		includeZero: true
	},
